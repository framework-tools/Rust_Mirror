...
mod tests {
    ...
    /// Output:
    /// <p5/>
    /// <LayoutBlock> <C1></p2></C1> <C2><p3/></p4></C2> </LayoutBlock>
    #[test]
    fn can_handle_editing_inside_layout_block_with_external_block_above() {
        let mut new_ids = NewIds::hardcoded_new_ids_for_tests();
        ...
        let root_block = RootBlock::json_from(root_block_id.clone(), vec![paragraph_block_id5.clone(), layout_block_id.clone()]).to_string();

        let block_map = BlockMap::from(vec![
            inline_block1, inline_block2, inline_block3, inline_block4, inline_block5,
        ...
        let anchor = SubSelection {
            ...
            offset: 0,
            subselection: Some(Box::new(SubSelection { block_id: inline_block_id5.clone(), offset: 2, subselection: None }))
        };
        let head = SubSelection {
            block_id: layout_block_id.clone(),
            offset: 0,
            subselection: Some(Box::new(SubSelection {
                block_id: layout_column_id1.clone(),
                offset: 0,
        ...
        let updated_inline5 = updated_state.block_map.get_inline_block(&inline_block_id5).unwrap();
        assert_eq!(updated_inline5.text().unwrap().clone().to_string(), "heodbye".to_string());

        let updated_root = updated_state.block_map.get_root_block(&root_block_id).unwrap();
        assert_eq!(updated_root.children, vec![paragraph_block_id5.clone(), layout_block_id.clone()]);

        let updated_layout_block = updated_state.block_map.get_standard_block(&layout_block_id).unwrap();
        assert_eq!(updated_layout_block.children, vec![layout_column_id1.clone(), layout_column_id2.clone()]);

        let updated_column1 = updated_state.block_map.get_standard_block(&layout_column_id1).unwrap();
        assert_eq!(updated_column1.children, vec![paragraph_block_id2.clone()]);
    ...
    /// Output:
    /// <p5/>
    /// <LayoutBlock> <C1></C1> <C2><p3/></p4></C2> </LayoutBlock>
    #[test]
    fn can_handle_editing_inside_layout_block_with_external_block_above_2() {
        let mut new_ids = NewIds::hardcoded_new_ids_for_tests();
        ...
        let head = SubSelection {
            ...
            subselection: Some(Box::new(SubSelection {
                ...
                subselection: Some(Box::new(SubSelection {
                    ...
                    offset: 0,
                    subselection: Some(Box::new(SubSelection { block_id: inline_block_id2.clone(), offset: 2, subselection: None })),
                }))
            }))
        };
        ...
        let updated_column1 = updated_state.block_map.get_standard_block(&layout_column_id1).unwrap();
        assert_eq!(updated_column1.children.len(), 0);
    ...
    /// <LayoutBlock> <C1></C1> <C2><p3/></p4></C2> </LayoutBlock>
    #[test]
    fn can_handle_editing_inside_layout_block_with_external_block_above_3() {
        let mut new_ids = NewIds::hardcoded_new_ids_for_tests();
    ...
    /// <LayoutBlock> <C1></C1> <C2><p3/></p4></C2> </LayoutBlock>
    #[test]
    fn can_handle_editing_inside_layout_block_with_external_block_above_4() {
        let mut new_ids = NewIds::hardcoded_new_ids_for_tests();
        ...
        let head = SubSelection {
            ...
            subselection: Some(Box::new(SubSelection {
                ...
                offset: 0,
                subselection: Some(Box::new(SubSelection {
                    block_id: paragraph_block_id4.clone(),
                    offset: 0,
                    subselection: Some(Box::new(SubSelection { block_id: inline_block_id4.clone(), offset: 2, subselection: None })),
                }))
            }))
        };
    ...
    /// <LayoutBlock> <C1></C1> <C2><p3/></p4></C2> </LayoutBlock>
    #[test]
    fn can_handle_editing_inside_layout_block_with_external_block_below_1() {
        let mut new_ids = NewIds::hardcoded_new_ids_for_tests();
        ...
        let root_block = RootBlock::json_from(root_block_id.clone(), vec![layout_block_id.clone(), paragraph_block_id5.clone()]).to_string();
        ...
        let updated_root = updated_state.block_map.get_root_block(&root_block_id).unwrap();
        assert_eq!(updated_root.children, vec![layout_block_id.clone()]);

        let updated_layout_block = updated_state.block_map.get_standard_block(&layout_block_id).unwrap();
        assert_eq!(updated_layout_block.children, vec![layout_column_id1.clone(), layout_column_id2.clone()]);

        let updated_column1 = updated_state.block_map.get_standard_block(&layout_column_id1).unwrap();
        assert_eq!(updated_column1.children.len(), 2);

        let updated_column2 = updated_state.block_map.get_standard_block(&layout_column_id2).unwrap();
        assert_eq!(updated_column2.children.len(), 2);
    }
    ...
    /// <LayoutBlock> <C1></C1> <C2><p3/></p4></C2> </LayoutBlock>
    #[test]
    fn can_handle_editing_inside_layout_block_with_external_block_below_2() {
        let mut new_ids = NewIds::hardcoded_new_ids_for_tests();
