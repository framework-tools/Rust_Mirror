...
mod tests {
    ...
    fn get_blocks_test1_flat() {
        ...
        assert_eq!(blocks_as_tree[0].id(), std_block_id1);
        assert_eq!(blocks_as_tree[1].id(), std_block_id4);
        assert_eq!(blocks_as_tree[2].id(), std_block_id5);
        assert_eq!(blocks_as_tree[3].id(), std_block_id3);
        assert_eq!(blocks_as_tree.len(), 4);
    }
}