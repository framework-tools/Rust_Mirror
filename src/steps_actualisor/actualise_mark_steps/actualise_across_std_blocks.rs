...
pub fn actualise_mark_step_on_standard_blocks(
    ...
    split_edge_inline_blocks(
        &mut block_map,
        mark_step.from_new_inline_id,
        from_deepest_layer,
    ...
    split_edge_inline_blocks(
        &mut block_map,
        mark_step.to_new_inline_id,
        to_deepest_layer,
        to_deepest_std_block,
        &mut blocks_to_update
    )?;
...
pub fn split_edge_inline_blocks(
    ...
    let (first_half, second_half) = inline_block.split(deepest_layer.offset, new_inline_block_id)?;
